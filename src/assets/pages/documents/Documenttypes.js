    ...
    const modals = [
        {
            ...
            heading: 'Document Type Added Successfully!',
            Details: 'The new Document Type has been created and is now available.',
            leftBTN: 'Submit & Go Document Type',
            LeftColorBTN: "greenBTN",
            colorCode: 'green',
        },
        {
            indicator: Wavy_Warning,
            heading: 'Are you sure you want to deactivate this Document Type?',
        ...
        },
        {
            ...
            heading: 'Reactivate Document Type',
        ...
        {
            indicator: delet,
            heading: 'Document Type Deleted Successfully!',
            Details: 'The Document Type has been permanently removed from the system.',
            leftBTN: 'Go to Document ',
            LeftColorBTN: "greenBTN",
            colorCode: 'green',
            conformationData: ''
        },
        {
            ...
            Details: 'The Document  profile has been successfully reactivated and they now have access to the platform.',
        ...
        {
            indicator: Wavy_Warning,
            heading: 'Are you sure you want to delete this Document Type?',
            Details: 'This action will permanently remove the Document Type and all associated data. This cannot be undone.',
            leftBTN: 'Yes’ Delete',
            LeftColorBTN: "redBTN",
            rightBTN: 'Cancel',
            colorCode: 'red',
        ...
        {
            indicator: Stop_Sign,
            heading: 'Document Type Deactivated Successfully!',
            Details: 'The Document Type has been deactivated. They no longer have access to their account.',
            leftBTN: 'Back to Document',
            LeftColorBTN: "greenBTN",
            colorCode: 'green',
            conformationData: ''
            ...
            <div className="offcanvas_main">
                <Offcanvas show={newRequest} onHide={handleClose} placement="end" backdrop="static" style={{ width: '40%' }} className="offcanvas_wrapper" >
                    <Offcanvas.Header closeButton className='offcanvas_header'>
                        <Offcanvas.Title>Add New Document Type</Offcanvas.Title>
                    </Offcanvas.Header>
                    <Offcanvas.Body>
                        <div className="offcanvas_body">
                            <p className="doneMessage">Fill in the details below to create a new Category. Streamline your organizational structure and manage Assets effectively..</p>
                                        ...
                                        <Form noValidate validated={validated} onSubmit={(e) => handleSubmit(e, "requestDone")}>
                                            <Row className="mb-3">
                                                <Form.Group as={Col} md="12" controlId="validationCustom01">
                                                    <Form.Label>Type Code <img src={star} alt="" /></Form.Label>
                                                    <Form.Control
                                                        required
                                                        type="text"
                                                ...
                                                <Form.Group as={Col} md="12" controlId="validationCustomUsername">
                                                    <Form.Label>Type Name <img src={star} alt="" /></Form.Label>
