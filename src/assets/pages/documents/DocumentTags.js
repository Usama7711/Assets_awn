    ...
    const modals = [
        {
            ...
            heading: 'Document Tag Added Successfully!',
            Details: 'The new Document Tag has been created and is now available.',
            leftBTN: 'Submit & Go Document Tag',
            LeftColorBTN: "greenBTN",
            colorCode: 'green',
        },
        {
            indicator: Wavy_Warning,
            heading: 'Are you sure you want to deactivate this Document Tag?',
        ...
        },
        {
            ...
            heading: 'Reactivate Document Tag',
        ...
        {
            indicator: delet,
            heading: 'Document Tag Deleted Successfully!',
            Details: 'The Document Tag has been permanently removed from the system.',
            leftBTN: 'Go to Document Tag ',
            LeftColorBTN: "greenBTN",
            colorCode: 'green',
            conformationData: ''
        },
        ...
        {
            indicator: Wavy_Warning,
            heading: 'Are you sure you want to delete this Document Tag?',
            Details: 'This action will permanently remove the Document Tag and all associated data. This cannot be undone.',
            leftBTN: 'Yes’ Delete',
            LeftColorBTN: "redBTN",
            rightBTN: 'Cancel',
            colorCode: 'red',
        ...
        {
            indicator: Stop_Sign,
            heading: 'Document Tag Deactivated Successfully!',
            Details: 'The Document Tag has been deactivated. They no longer have access to their account.',
            leftBTN: 'Back to Document',
            LeftColorBTN: "greenBTN",
            colorCode: 'green',
            conformationData: ''
    ...
    return (
        ...
        >
            <div className='commom_main_heading'>
                <div className="">
                    <p className="heading">Document Tags</p>
                </div>
            ...
            <div className="offcanvas_main">
                <Offcanvas show={newRequest} onHide={handleClose} placement="end" backdrop="static" style={{ width: '40%' }} className="offcanvas_wrapper" >
                    <Offcanvas.Header closeButton className='offcanvas_header'>
                        <Offcanvas.Title>Add New Document Tag</Offcanvas.Title>
                    </Offcanvas.Header>
                    <Offcanvas.Body>
                        <div className="offcanvas_body">
                            <p className="">Fill in the details below to create a new Category. Streamline your organizational structure and manage Assets effectively.</p>
                                        ...
                                        <Form noValidate validated={validated} onSubmit={(e) => handleSubmit(e, "requestDone")}>
                                            <Row className="mb-3">
                                                <Form.Group as={Col} md="12" controlId="validationCustom01">
                                                    <Form.Label>Document Tag Code <img src={star} alt="" /></Form.Label>
                                                    <Form.Control
                                                        required
                                                        type="text"
                                                        placeholder="Enter Document Tag Code"
                                                    />
                                                    <Form.Control.Feedback>Looks good!</Form.Control.Feedback>
                                                </Form.Group>
                                                <Form.Group as={Col} md="12" controlId="validationCustomUsername">
                                                    <Form.Label>Document Tag Name <img src={star} alt="" /></Form.Label>
