...
import CreatedPersone from "../../assets/Created_Persone.png"
        ...
        >
                            ...
                            <th>
                                <Dropdown as="div">
                                    ...
                                    <Dropdown.Menu>
                                        ...
                                        <Dropdown.Item onClick={() => handleShowCustomerDone()}>
                                            View Request
                                        </Dropdown.Item>
                                                ...
                                                <div className="form_wrapper">
                                                    <Form noValidate validated={validated}>
                                                        ...
                                                        <div className="form_btn_wrapper">
                                                            ...
                                                            <Button onClick={(e) => handleSubmit()} className='Submit_btn'>Submit</Button>
                                                        </div>
                                                    </Form>
            ...
            <div className="offcanvas_main">
                <Offcanvas show={customerDone} onHide={handleCloseCustomerDone} placement="end" backdrop="static" style={{ width: '40%' }} className="offcanvas_wrapper" >
                    <Offcanvas.Header closeButton className='offcanvas_header'>
                        <Offcanvas.Title>
                            <img src={backArrow} alt="" onClick={handleCloseCustomerDone} />
                            Requests
                        </Offcanvas.Title>
                    </Offcanvas.Header>
                    <Offcanvas.Body>
